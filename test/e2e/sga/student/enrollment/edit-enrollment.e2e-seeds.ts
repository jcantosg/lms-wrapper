...
export class EditEnrollmentE2eSeed implements E2eSeed {
  ...
  async arrange(): Promise<void> {
    ...
    this.businessUnit = BusinessUnit.create(
      EditEnrollmentE2eSeed.businessUnitId,
      EditEnrollmentE2eSeed.businessUnitName,
      EditEnrollmentE2eSeed.businessUnitCode,
      country,
      this.superAdminUser,
    );
    ...
    this.virtualCampus = VirtualCampus.create(
      EditEnrollmentE2eSeed.virtualCampusId,
      EditEnrollmentE2eSeed.virtualCampusName,
      EditEnrollmentE2eSeed.virtualCampusCode,
      this.businessUnit,
      this.superAdminUser,
    );
    ...
    this.superAdminUser = await createAdminUser(
      this.datasource,
      EditEnrollmentE2eSeed.superAdminUserId,
    ...
    this.adminUser = await createAdminUser(
      this.datasource,
      EditEnrollmentE2eSeed.adminUserId,
    ...
    this.academicProgram = AcademicProgram.create(
      EditEnrollmentE2eSeed.academicProgramId,
      EditEnrollmentE2eSeed.academicProgramName,
      EditEnrollmentE2eSeed.academicProgramCode,
      this.title,
      this.businessUnit,
      this.superAdminUser,
    ...
    this.academicPeriod = AcademicPeriod.create(
      EditEnrollmentE2eSeed.academicPeriodId,
      EditEnrollmentE2eSeed.academicPeriodName,
      EditEnrollmentE2eSeed.academicPeriodCode,
      new Date(EditEnrollmentE2eSeed.academicPeriodStartDate),
      new Date(EditEnrollmentE2eSeed.academicPeriodEndDate),
      this.businessUnit,
      EditEnrollmentE2eSeed.academicPeriodBlocksNumber,
      this.superAdminUser,
    );
    ...
    this.programBlock = ProgramBlock.create(
      EditEnrollmentE2eSeed.programBlockId,
      EditEnrollmentE2eSeed.programBlockName,
      this.academicProgram,
      this.superAdminUser,
    );
    const evaluationType = await this.evaluationTypeRepository.findOneByOrFail({
      id: EditEnrollmentE2eSeed.subjectEvaluationType,
    });
    this.subject = Subject.create(
      EditEnrollmentE2eSeed.subjectId,
      null,
      EditEnrollmentE2eSeed.subjectName,
      EditEnrollmentE2eSeed.subjectCode,
      null,
      EditEnrollmentE2eSeed.subjectHours,
      EditEnrollmentE2eSeed.subjectModality,
      evaluationType,
      EditEnrollmentE2eSeed.subjectType,
      this.businessUnit,
      EditEnrollmentE2eSeed.subjectIsRegulated,
      EditEnrollmentE2eSeed.subjectIsCore,
      this.superAdminUser,
      null,
    );
    ...
    this.academicRecord = AcademicRecord.create(
      EditEnrollmentE2eSeed.academicRecordId,
      this.businessUnit,
      this.virtualCampus,
      this.student,
      this.academicPeriod,
    ...
    this.student = Student.createFromSGA(
      EditEnrollmentE2eSeed.studentId,
      EditEnrollmentE2eSeed.studentName,
      EditEnrollmentE2eSeed.studentSurname,
      EditEnrollmentE2eSeed.studentSurname2,
    ...
    this.enrollment = Enrollment.create(
      EditEnrollmentE2eSeed.enrollmentId,
      this.subject,
      this.academicRecord,
  ...
  async clear(): Promise<void> {
    ...
    await this.enrollmentRepository.delete(EditEnrollmentE2eSeed.enrollmentId);
