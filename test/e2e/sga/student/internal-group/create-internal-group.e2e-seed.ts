...
export class CreateInternalGroupE2eSeed implements E2eSeed {
  ...
  async arrange(): Promise<void> {
    ...
    this.businessUnit = BusinessUnit.create(
      CreateInternalGroupE2eSeed.businessUnitId,
      CreateInternalGroupE2eSeed.businessUnitName,
      CreateInternalGroupE2eSeed.businessUnitCode,
      country,
      this.superAdminUser,
    );
    ...
    this.superAdminUser = await createAdminUser(
      this.datasource,
      CreateInternalGroupE2eSeed.superAdminUserId,
    ...
    this.adminUser = await createAdminUser(
      this.datasource,
      CreateInternalGroupE2eSeed.adminUserId,
    ...
    this.subject = Subject.create(
      CreateInternalGroupE2eSeed.subjectId,
      null,
      'subject',
      'code',
      null,
    ...
    this.academicProgram = AcademicProgram.create(
      CreateInternalGroupE2eSeed.academicProgramId,
      CreateInternalGroupE2eSeed.academicProgramName,
      CreateInternalGroupE2eSeed.academicProgramCode,
      this.title,
      this.businessUnit,
      this.superAdminUser,
    ...
    this.programBlock = ProgramBlock.create(
      CreateInternalGroupE2eSeed.programBlockId,
      CreateInternalGroupE2eSeed.programBlockName,
    ...
    this.academicPeriod = AcademicPeriod.create(
      CreateInternalGroupE2eSeed.academicPeriodId,
      CreateInternalGroupE2eSeed.academicPeriodName,
      CreateInternalGroupE2eSeed.academicPeriodCode,
      new Date(CreateInternalGroupE2eSeed.academicPeriodStartDate),
      new Date(CreateInternalGroupE2eSeed.academicPeriodEndDate),
      this.businessUnit,
      CreateInternalGroupE2eSeed.academicPeriodBlocksNumber,
      this.superAdminUser,
    );
    this.academicPeriod.academicPrograms.push(this.academicProgram);

    this.periodBlock = PeriodBlock.create(
      CreateInternalGroupE2eSeed.periodBlockId,
      this.academicPeriod,
      CreateInternalGroupE2eSeed.name,
    ...
    await this.blockRelationRepository.save(
      BlockRelation.create(
        CreateInternalGroupE2eSeed.blockRelationId,
        this.periodBlock,
        this.programBlock,
        this.superAdminUser,
      ),
