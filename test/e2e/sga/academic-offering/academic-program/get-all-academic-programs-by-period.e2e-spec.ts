...
const path = `/academic-period/${GetAllAcademicProgramsByAcademicPeriodE2eSeed.academicPeriodId}/academic-program`;

describe('GET /academic-period/:academicPeriodId/academic-program', () => {
  ...
  it('should return 400 for invalid academic period id', async () => {
    ...
    await supertest(httpServer)
      .get(`/academic-period/${invalidId}/academic-program`)
      .auth(superAdminAccessToken, { type: 'bearer' })
      .expect(400);
  });
  ...
  it('should return 404 for non-existent academic period id', async () => {
    ...
    await supertest(httpServer)
      .get(`/academic-period/${nonExistentId}/academic-program`)
      .auth(superAdminAccessToken, { type: 'bearer' })
      .expect(404);
  });
