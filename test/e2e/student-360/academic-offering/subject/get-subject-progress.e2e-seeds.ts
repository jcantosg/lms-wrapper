...
export class GetSubjectProgressE2eSeed implements E2eSeed {
  ...
  async arrange(): Promise<void> {
    ...
    this.businessUnit = BusinessUnit.create(
      GetSubjectProgressE2eSeed.businessUnitId,
      GetSubjectProgressE2eSeed.businessUnitName,
      GetSubjectProgressE2eSeed.businessUnitCode,
      country,
      this.superAdminUser,
    );
    ...
    this.secondBusinessUnit = BusinessUnit.create(
      GetSubjectProgressE2eSeed.secondBusinessUnitId,
      GetSubjectProgressE2eSeed.secondBusinessUnitName,
      GetSubjectProgressE2eSeed.secondBusinessUnitCode,
      country,
      this.superAdminUser,
    );
    ...
    this.virtualCampus = VirtualCampus.create(
      GetSubjectProgressE2eSeed.virtualCampusId,
      GetSubjectProgressE2eSeed.virtualCampusName,
      GetSubjectProgressE2eSeed.virtualCampusCode,
      this.businessUnit,
      this.superAdminUser,
    );
    ...
    this.superAdminUser = await createAdminUser(
      this.datasource,
      GetSubjectProgressE2eSeed.superAdminUserId,
      GetSubjectProgressE2eSeed.superAdminUserEmail,
      GetSubjectProgressE2eSeed.superAdminUserPassword,
      [AdminUserRoles.SUPERADMIN],
      [this.businessUnit],
    );

    this.title = Title.create(
      GetSubjectProgressE2eSeed.titleId,
      GetSubjectProgressE2eSeed.titleName,
      GetSubjectProgressE2eSeed.titleOfficialCode,
      GetSubjectProgressE2eSeed.titleOfficialTitle,
      GetSubjectProgressE2eSeed.titleOfficialProgram,
      this.businessUnit,
      this.superAdminUser,
    );
    ...
    this.academicProgram = AcademicProgram.create(
      GetSubjectProgressE2eSeed.academicProgramId,
      GetSubjectProgressE2eSeed.academicProgramName,
      GetSubjectProgressE2eSeed.academicProgramCode,
      this.title,
      this.businessUnit,
      this.superAdminUser,
    ...
    this.subject = Subject.create(
      GetSubjectProgressE2eSeed.subjectId,
      null,
      GetSubjectProgressE2eSeed.subjectName,
      GetSubjectProgressE2eSeed.subjectCode,
      null,
      null,
      GetSubjectProgressE2eSeed.subjectModality,
      evaluationType,
      GetSubjectProgressE2eSeed.subjectType,
      this.businessUnit,
      true,
      true,
      this.superAdminUser,
    ...
    this.nonEnrolledSubject = Subject.create(
      ...
      null,
      GetSubjectProgressE2eSeed.nonEnrolledSubjectIdSubjectName,
      GetSubjectProgressE2eSeed.nonEnrolledSubjectIdSubjectCode,
      null,
      null,
      GetSubjectProgressE2eSeed.nonEnrolledSubjectModality,
      evaluationType,
      GetSubjectProgressE2eSeed.nonEnrolledSubjectType,
      this.businessUnit,
      true,
      true,
      this.superAdminUser,
    ...
    this.academicPeriod = AcademicPeriod.create(
      GetSubjectProgressE2eSeed.academicPeriodId,
      GetSubjectProgressE2eSeed.academicPeriodName,
      GetSubjectProgressE2eSeed.academicPeriodCode,
      new Date(GetSubjectProgressE2eSeed.academicPeriodStartDate),
      new Date(GetSubjectProgressE2eSeed.academicPeriodEndDate),
      this.businessUnit,
      GetSubjectProgressE2eSeed.academicPeriodBlocksNumber,
      this.superAdminUser,
    );
    ...
    this.programBlock = ProgramBlock.create(
      GetSubjectProgressE2eSeed.programBlockId,
      GetSubjectProgressE2eSeed.programBlockName,
    ...
    this.student = Student.createFromSGA(
      GetSubjectProgressE2eSeed.studentId,
      GetSubjectProgressE2eSeed.studentName,
      GetSubjectProgressE2eSeed.studentSurname,
      GetSubjectProgressE2eSeed.studentSurname2,
      GetSubjectProgressE2eSeed.studentEmail,
      GetSubjectProgressE2eSeed.studentUniversaeEmail,
      this.superAdminUser,
      await passwordEncoder.encodePassword(
        GetSubjectProgressE2eSeed.studentPassword,
      ),
      null,
    );
    ...
    this.academicRecord = AcademicRecord.create(
      GetSubjectProgressE2eSeed.academicRecordId,
      this.businessUnit,
      this.virtualCampus,
      this.student,
      this.academicPeriod,
      ...
      GetSubjectProgressE2eSeed.academicRecordIsModular,
      this.superAdminUser,
    );
