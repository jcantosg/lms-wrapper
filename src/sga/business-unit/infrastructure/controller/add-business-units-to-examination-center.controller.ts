...
import { AddBusinessUnitsToExaminationCenterCommand } from '../../application/examination-center/add-business-units-to-examination-center/add-business-units-to-examination-center.command';
