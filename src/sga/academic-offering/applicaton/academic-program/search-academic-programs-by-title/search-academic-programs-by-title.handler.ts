...
import { SearchAcademicProgramsByTitleCriteria } from '#academic-offering/applicaton/academic-program/search-academic-programs-by-title/search-academic-programs-by-title.criteria';
