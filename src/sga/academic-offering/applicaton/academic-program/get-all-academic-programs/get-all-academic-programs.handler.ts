...
import { GetAllAcademicsProgramsCriteria } from '#academic-offering/applicaton/academic-program/get-all-academic-programs/get-all-academics-programs.criteria';
