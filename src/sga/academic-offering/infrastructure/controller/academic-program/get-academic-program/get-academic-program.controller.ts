...
import { GetAcademicProgramResponse } from '#academic-offering/infrastructure/controller/academic-program/get-academic-program/get-academic-program.response';
