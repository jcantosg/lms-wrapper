...
import { TitleResponse } from '#academic-offering/infrastructure/controller/get-all-titles-list/get-title-list.response';
import { GetAllTitlesResponse } from '#academic-offering/infrastructure/controller/get-all-titles-list/get-all-title-list.response';
